...
public class AddressController {
    ...
    public ResponseData addressList(HttpServletRequest request) {
        UserInfoDto userInfo = (UserInfoDto) request.getAttribute(TokenIntercepter.USER_INFO_KEY);
        Long uid = userInfo.getUid();
//        JSONObject object = JSON.parseObject(userInfo.toString());
//        Long uid = Long.parseLong(object.get("uid").toString());
        AddressListRequest addressListRequest = new AddressListRequest();
        addressListRequest.setUserId(userInfo.getUid());
