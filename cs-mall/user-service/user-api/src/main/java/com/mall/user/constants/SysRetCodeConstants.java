...
public enum SysRetCodeConstants {
    ...
    EMAIL_ALREADY_EXISTS                ("003009","邮箱已被使用"),
    VERIFY_FAIL                         ("003010","激活失败"),
    LOGIN_STATUS_INVALID                ("003011","未登录"),
    ...
    PHONE_NUMBER_ERROR                  ("003100","手机号码长度不足11位"),
    PHONE_NUMBER_ILLEGAL                ("003101","手机号码不合法"),
